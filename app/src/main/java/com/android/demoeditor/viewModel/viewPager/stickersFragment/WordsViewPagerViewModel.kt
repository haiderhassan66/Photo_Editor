...
class WordsViewPagerViewModel(application: Application): AndroidViewModel(application) {
    private val TAG = this::class.java.simpleName


    private var stickerList: TypedArray = application.resources.obtainTypedArray(R.array.words_photo)
