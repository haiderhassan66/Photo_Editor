...
import com.android.demoeditor.screens.BlurFragmentArgs
...
@HiltViewModel
class BlurScreenViewModel @Inject constructor(
    @ApplicationContext val context: Context,
    savedStateHandle: SavedStateHandle
    ) :
    ViewModel() {

    val navArgs: BlurFragmentArgs = BlurFragmentArgs.fromSavedStateHandle(savedStateHandle)

    private val backgroundScope = CoroutineScope(Dispatchers.IO + Job())

    companion object {
        private val TAG = BlurScreenViewModel::class.java.simpleName
    ...
    private fun setUriOrBitmap(navArgs: BlurFragmentArgs) {
